...
from routers.agent_router import agent_router  # 【W8-卡1】Agent 多步自主循环入口
...
app.include_router(agent_router, prefix="/api/agent", tags=["Agent多步问答"], dependencies=[Depends(verify_api_key)])
